// ==================================================
// SISTEMA DE PÁGINA DE POST - DELIVERYHJ
// ==================================================
...
class PostSystem {
    ...
    loadPostData() {
        ...
        this.postData = {
            id: 1,
            title: "A Rica História da Gastronomia Angolana: Dos Tempos Antigos aos Dias de Hoje",
        ...
        this.comments = [
            {
                ...
                date: "2024-12-16",
                content: "Artigo fantástico! Como angolana no estrangeiro, este texto me fez sentir em casa. Saudades da muamba da minha avó!",
                likes: 8
            },
            {
                id: 2,
                ...
                date: "2024-12-15",
                content: "Excelente trabalho de pesquisa! Gostaria de ver mais artigos sobre as variações regionais da culinária angolana.",
                likes: 5
            }
        ];
    }
    ...
    handleCommentSubmit(form) {
        ...
        setTimeout(() => {
            ...
            const newComment = {
                ...
                avatar: `https://ui-avatars.com/api/?name=${encodeURIComponent(commentData.author)}&background=dc3545&color=fff`,
                    ...
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div class="d-flex align-items-center">
                            <img src="${comment.avatar}"
                                class="author-avatar me-2" alt="${comment.author}">
                            <div>
                                <div class="fw-bold">${comment.author}</div>
                                <div class="text-muted small">${this.formatRelativeTime(comment.date)}</div>
                            </div>
                        </div>
                        <button class="btn btn-sm btn-outline-danger" data-comment-id="${comment.id}">
            ...
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    const percentage = Math.round(
                        (entry.boundingClientRect.top / (entry.rootBounds.height - entry.boundingClientRect.height)) * 100
                    );
