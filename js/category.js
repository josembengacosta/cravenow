// ==================================================
// SISTEMA DE CATEGORIAS - CraveNow
// ==================================================
...
class CategorySystem {
    ...
    this.categories = [
      {
        ...
        slug: "pizza",
        description:
          "As melhores pizzas da cidade, desde margherita clássica até sabores criativos.",
        image:
      ...
      },
      {
        ...
        slug: "tradicional",
        description:
          "Sabores autênticos de Angola. Muamba, funje, calulu e outras delícias locais.",
        image:
      ...
      },
      {
        ...
        slug: "sushi",
        description:
          "Sushi fresco e autêntico preparado por chefs especializados. Qualidade premium.",
        image:
      ...
      },
      {
        ...
        slug: "churrascaria",
        description:
          "Carnes selecionadas grelhadas na perfeição. Rodízio e porções generosas.",
        image:
      ...
      },
      {
        ...
        slug: "hamburguer",
        description:
          "Hamburgueres artesanais com blends especiais. Do clássico ao gourmet.",
        image:
      ...
      },
      {
        ...
        slug: "vegetariano",
        description:
          "Opções saudáveis e saborosas sem carne. Pratos criativos e nutritivos.",
        image:
      ...
      },
      {
        ...
        slug: "frutos-mar",
        description:
          "Peixes frescos, mariscos e pratos do mar. Da costa angolana para sua mesa.",
        image:
          "https://images.unsplash.com/photo-1563379091339-03246963d96f?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
        icon: "bi-water",
        color: "info",
        restaurantCount: 7,
        avgRating: 4.7,
      ...
      },
      {
        ...
        slug: "asiatica",
        description:
          "Culinária chinesa, tailandesa, japonesa e vietnamita. Sabores orientais autênticos.",
        image:
      ...
      },
      {
        ...
        description:
          "Cafés especiais, bolos, sobremesas e doces. Perfeito para um momento doce.",
        image:
    ...
    switch (this.filters.sortBy) {
      ...
      default:
        return categories.sort(
          (a, b) => b.stats.totalOrders - a.stats.totalOrders
        );
    }
  }
  ...
  createCategoryCard(category, isFeatured) {
    ...
    const growthIcon =
      category.stats.monthlyGrowth > 15
        ? "bi-arrow-up-right"
        : category.stats.monthlyGrowth > 5
        ? "bi-arrow-up"
        : "bi-arrow-down";
    const growthColor =
      category.stats.monthlyGrowth > 15
    ...
    col.innerHTML = `
      ...
      category.stats.monthlyGrowth
                    ...
                    <a href="${category.slug}.html" 
                       class="btn btn-${
                         isFeatured ? "danger" : "outline-danger"
                       } w-100"
  ...
  loadMoreCategories() {
    ...
    setTimeout(() => {
      ...
      this.showNotification(
        "Mais categorias carregadas com sucesso!",
        "success"
      );

      button.innerHTML =
        '<i class="bi bi-check-lg"></i> Todas as categorias carregadas';
      button.disabled = true;
  ...
  updateStats() {
    const totalRestaurants = this.filteredCategories.reduce(
      (sum, cat) => sum + cat.restaurantCount,
      0
    );
    const avgRating =
      this.filteredCategories.reduce((sum, cat) => sum + cat.avgRating, 0) /
    ...
    console.log(
      `📊 Estatísticas atualizadas: ${
        this.filteredCategories.length
      } categorias, ${totalRestaurants} restaurantes, rating médio: ${avgRating.toFixed(
        1
      )}`
    );
  }
  ...
  trackCategoryView(categoryId, categorySlug) {
    ...
    console.log(
      `📈 Categoria visualizada: ${categorySlug} (ID: ${categoryId})`
    );
    ...
    this.tradicionalRestaurants = [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1546833999-b9f581a1996d?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
        description:
          "Muamba tradicional feita com receita de família há mais de 50 anos.",
...
function getCategoryStats() {
  return window.categorySystem
    ? window.categorySystem.getCategoryStats()
    : null;
}
