...
class BlogSystem {
    ...
    this.posts = [
      {
        ...
        excerpt:
          "Aprenda como maximizar sua experiência de delivery com dicas simples que vão desde a escolha do restaurante até o momento da entrega.",
        category: "dicas",
        image:
      ...
      },
      {
        ...
        excerpt:
          "Descubra os segredos da receita tradicional de muamba que passa de geração em geração nas famílias angolanas.",
        category: "receitas",
        image:
      ...
      },
      {
        ...
        excerpt:
          "Conheça as novas opções gastronômicas que estão agitando a cena culinary da capital angolana.",
        category: "noticias",
        image:
      ...
      },
      {
        ...
        excerpt:
          "Tudo o que você precisa saber para criar uma celebração natalina autêntica com os sabores de Angola.",
        category: "dicas",
        image:
      ...
      },
      {
        ...
        excerpt:
          "Aprenda as técnicas ancestrais para preparar o funje na textura ideal, como faziam nossas avós.",
        category: "receitas",
        image:
      ...
      },
      {
        ...
        excerpt:
          "Descubra como manter uma alimentação balanceada mesmo pedindo delivery todos os dias.",
        category: "dicas",
        image:
  ...
  applyFilters() {
    ...
    if (this.currentFilter !== "all") {
      filtered = filtered.filter(
        (post) => post.category === this.currentFilter
      );
    }
    ...
    if (loadMoreBtn) {
      ...
      if (!hasMore && this.filteredPosts.length > 0) {
        loadMoreBtn.innerHTML =
          '<i class="bi bi-check-lg"></i> Todos os artigos carregados';
  ...
  createPostCard(post) {
    ...
    col.innerHTML = `
      ...
      post.category === "receitas" ? "text-dark" : ""
    }">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="text-muted small">${this.formatDate(
                                  post.date
                                )}</div>
                            </div>
                        </div>
                        <span class="text-muted small">
                            <i class="bi bi-eye"></i> ${this.formatViews(
                              post.views
                            )}
                        </span>
                    </div>
