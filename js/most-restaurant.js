// ==================================================
// SISTEMA MAIS POPULARES - CraveNow
// ==================================================
...
class PopularSystem {
    ...
    this.restaurants = [
      {
        ...
        description:
          "As pizzas mais amadas de Luanda. Massa artesanal e ingredientes premium.",
        rank: 1,
        stats: {
          weeklyOrders: 1250,
          approvalRate: 98,
      ...
      },
      {
        ...
        description:
          "Sushi autêntico com peixe fresco importado. Chef japonês especializado.",
        rank: 2,
        stats: {
          weeklyOrders: 890,
          approvalRate: 96,
      ...
      },
      {
        ...
        description:
          "Comida tradicional com receitas de família. Muamba, funje e calulu autênticos.",
        rank: 3,
        stats: {
          weeklyOrders: 1500,
          approvalRate: 94,
      ...
      },
      {
        ...
        description:
          "Peixes e mariscos frescos da costa angolana. Pratos sofisticados do mar.",
        rank: 7,
        stats: {
          weeklyOrders: 320,
          approvalRate: 95,
      ...
      },
      {
        ...
        description:
          "Culinária asiática autêntica. Pratos chineses, tailandeses e japoneses.",
        rank: 8,
        stats: {
          weeklyOrders: 680,
          approvalRate: 90,
    ...
    switch (this.filters.sortBy) {
      case "reviews":
        return restaurants.sort(
          (a, b) => b.stats.totalReviews - a.stats.totalReviews
        );
      case "orders":
        return restaurants.sort(
          (a, b) => b.stats.weeklyOrders - a.stats.weeklyOrders
        );
      case "trending":
    ...
    if (loadMoreBtn) {
      ...
      if (!hasMore && others.length > 0) {
        loadMoreBtn.innerHTML =
          '<i class="bi bi-check-lg"></i> Todos os restaurantes carregados';
  ...
  createRestaurantCard(restaurant) {
    ...
    const rankClass = `rank-${
      restaurant.rank <= 3 ? restaurant.rank : "other"
    }`;
    const priceSymbols = ["$", "$$", "$$$"];
    const growthIcon =
      restaurant.stats.growth > 20
        ? "bi-arrow-up-right"
        : restaurant.stats.growth > 10
        ? "bi-arrow-up"
        : "bi-arrow-down";
    const growthColor =
      restaurant.stats.growth > 20
      ...
      restaurant.stats.growth
                    ...
                    <div class="restaurant-stats">
                        <div class="row text-center small">
                            <div class="col-4">
                                <div class="fw-bold text-primary">${this.formatNumber(
                                  restaurant.stats.weeklyOrders
                                )}</div>
                                <div class="text-muted">Pedidos</div>
                            </div>
                            <div class="col-4">
                                <div class="fw-bold text-success">${
                                  restaurant.stats.approvalRate
                                }%</div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex align-items-center mb-2">
                                <h5 class="card-title fw-bold mb-0 me-3">${
                                  restaurant.name
                                }</h5>
                                <span class="badge bg-light text-dark">
                                    <i class="bi bi-star-fill text-warning"></i> ${
  ...
  switchView(view) {
    ...
    this.showNotification(
      `Visualização alterada para: ${view === "grid" ? "Grade" : "Lista"}`,
      "info"
    );
  }
  ...
  updateGlobalStats() {
    ...
    const totalOrders = this.filteredRestaurants.reduce(
      (sum, rest) => sum + rest.stats.weeklyOrders,
      0
    );
    const avgRating =
      this.filteredRestaurants.reduce((sum, rest) => sum + rest.rating, 0) /
      this.filteredRestaurants.length;
  ...
  trackRestaurantClick(restaurantId) {
    ...
    if (restaurant) {
      console.log(
        `📈 Restaurante clicado: ${restaurant.name} (Rank: ${restaurant.rank})`
      );
    }
  }
