  ...
  loadFAQData() {
    ...
    this.faqData = [
      // Pedidos
      {
        ...
        answer: "Fazer um pedido na CraveNow é muito simples...",
        category: "pedidos",
      ...
      },
      {
        ...
        answer:
          "Você pode cancelar um pedido enquanto ele estiver com status...",
        category: "pedidos",
      ...
      },
      {
        ...
        answer:
          "Se seu pagamento foi recusado, aqui estão as possíveis causas...",
        category: "pagamentos",
  ...
  displaySearchResults(searchTerm) {
    ...
    categoriesWithResults.forEach((category) => {
      ...
      if (categoryElement) {
        ...
        // Expand first result
        const firstResult = this.searchResults.find(
...
function shareFAQ() {
  if (navigator.share) {
    navigator.share({
      title: "CraveNow - Perguntas Frequentes",
      text: "Confira as perguntas frequentes da CraveNow",
