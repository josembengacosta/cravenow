...
class PartnerResourcesSystem {
    ...
    this.resources = [
      {
        ...
        downloads: 1200,
        description:
          "Aprenda a usar todas as funcionalidades do seu painel de controle.",
      },
      {
        id: "kit-marketing",
        ...
        downloads: 450,
        description:
          "Materiais prontos para redes sociais e estratégias de fidelização.",
      },
  ...
  applyFilters() {
    ...
    resourceCards.forEach((card) => {
      ...
      const accessMatch =
        this.filters.access === "all" || access === this.filters.access;
      const searchMatch =
        !this.filters.search ||
  ...
  updateResultsCount(count) {
    ...
    if (!countElement) {
      ...
      document
        .querySelector(".partners-resources-section")
  ...
  showAccessRequiredModal(resource) {
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center py-4">
                            ...
                            <p class="text-muted">
                                Este recurso está disponível apenas para parceiros com plano <strong>${this.getAccessLevelName(
                                  resource.access
                                )}</strong>.
                            </p>
                            <div class="alert alert-info">
                                <i class="bi bi-info-circle"></i>
                                <strong>Benefícios do plano ${this.getAccessLevelName(
                                  resource.access
                                )}:</strong>
    ...
    const modal = new bootstrap.Modal(
      document.getElementById("accessRequiredModal")
    );
    modal.show();
  }
  ...
  showDownloadCompleteModal(toolId) {
    ...
    const modal = new bootstrap.Modal(
      document.getElementById("partnerDownloadCompleteModal")
    );
    modal.show();
  }
  ...
  trackPartnerResourceAction(element) {
    ...
    const resourceTitle = resourceCard
      ? resourceCard.querySelector("h5").textContent
      : "Unknown";
