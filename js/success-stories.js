...
class SuccessStoriesSystem {
    ...
    this.stories = [
      {
        ...
        description:
          "Em apenas 12 meses, o Pizza Palace transformou seu faturamento e se tornou um dos restaurantes mais populares da capital.",
        image:
      ...
      },
      {
        ...
        description:
          "Especializado em culinária japonesa, o Sushi Master viu suas vendas online crescerem 280%.",
        image:
      ...
      },
      {
        ...
        description:
          "João transformou sua vida através do delivery, tornando-se um dos entregadores mais bem avaliados.",
        image:
      ...
      },
      {
        ...
        description:
          "Restaurante familiar que digitalizou suas receitas tradicionais e aumentou em 320% seu alcance.",
        image:
  ...
  applyFilters() {
    ...
    storyCards.forEach((card) => {
      ...
      const shouldShow = this.filters[this.currentFilter]({
        category: categories,
      });
...
function shareSuccessStory(storyId, platform = "whatsapp") {
  const story = window.successStoriesSystem.stories.find(
    (s) => s.id === storyId
  );
  if (!story) return;

  const text = `Confira esta história de sucesso na CraveNow: ${story.title}`;
  ...
  if (window.successStoriesSystem) {
    window.successStoriesSystem.trackEvent("story_share", {
      storyId,
      platform,
    });
  }
