...
class CareersSystem {
    ...
    initializeEventListeners() {
        ...
        document.addEventListener('click', (e) => {
            if (e.target.closest('.btn-danger') && e.target.textContent.includes('Candidate-se')) {
        ...
        this.jobs = [
            {
                ...
                featured: true,
                salary: 'Competitivo',
                description: 'Procuramos um desenvolvedor full stack para ajudar a construir e escalar nossa plataforma de delivery.',
                responsibilities: [
            ...
            },
            {
                ...
                description: 'Responsável por otimizar processos operacionais e garantir a eficiência da cadeia de delivery.',
                responsibilities: [
    ...
    applyFilters() {
        ...
        jobCards.forEach(card => {
            ...
            const departmentMatch = this.filters.department === 'all' || department === this.filters.department;
            const cityMatch = this.filters.city === 'all' || city === this.filters.city;
    ...
    handleCareerForm(event) {
        ...
        submitButton.innerHTML = '<i class="bi bi-arrow-repeat spinner-border spinner-border-sm"></i> Processando...';
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center py-4">
                            ...
                            <p class="text-muted">
                                Sua candidatura para <strong>${this.getPositionName(formData.position)}</strong> 
                                foi recebida com sucesso.
                            </p>
                            
                            <div class="alert alert-success mt-3">
                                <i class="bi bi-info-circle"></i>
                                <strong>Número da candidatura:</strong> ${formData.applicationId}
                            </div>
        ...
        const errorHTML = `
            <div class="alert alert-danger alert-dismissible fade show mt-3" role="alert">
                ...
                <div class="d-flex gap-2">
                    <a href="mailto:carreiras@deliveryhj.com" class="btn btn-sm btn-primary">
    ...
    handlePartnershipForm(event) {
        ...
        const submitButton = form.querySelector('button[type="submit"]');
        const originalText = submitButton.innerHTML;
        submitButton.innerHTML = '<i class="bi bi-arrow-repeat spinner-border spinner-border-sm"></i> A processar...';
        submitButton.disabled = true;
    ...
    showPartnershipSuccess(formData) {
        ...
        const modal = new bootstrap.Modal(document.getElementById('partnershipSuccessModal'));
        modal.show();
    }
    ...
    trackJobView(button) {
        const jobTitle = button.closest('.job-card').querySelector('h5').textContent;
    ...
    fillDemoApplication() {
        ...
        document.getElementById('coverLetter').value = 'Tenho 4 anos de experiência em desenvolvimento full stack e estou muito interessado em fazer parte da equipa DeliveryHJ. Admiro o trabalho de vocês em revolucionar o delivery em Angola e gostaria de contribuir com minhas habilidades técnicas.';
    ...
    fillDemoPartnership() {
        ...
        document.getElementById('partnerEmail').value = 'geral@saborestradicionais.com';
        document.getElementById('partnerPhone').value = '+244 922 123 456';
        document.getElementById('partnerCity').value = 'luanda';
        document.getElementById('partnerMessage').value = 'Gostaríamos de fazer parte da vossa rede de parceiros. Temos um restaurante especializado em comida tradicional angolana com excelentes avaliações.';
        
        this.showToast('Formulário de parceria preenchido com dados de demonstração', 'info');
    }
}
...
function testApplication(type = 'desenvolvedor') {
    const testData = {
        desenvolvedor: {
            ...
            coverLetter: 'Sou desenvolvedora full stack com experiência em React, Node.js e AWS. Tenho trabalhado em aplicações de grande escala e estou animada com a oportunidade de contribuir para a plataforma DeliveryHJ.'
        },
        marketing: {
            name: 'Carlos Santos',
            email: 'carlos.santos@email.com',
            position: 'marketing-digital',
            coverLetter: 'Com 5 anos de experiência em marketing digital, especializei-me em growth hacking e aquisição de utilizadores. Gostaria de aplicar minhas habilidades para expandir a base de clientes da DeliveryHJ.'
        },
        operacoes: {
            name: 'Maria Fernandes',
            email: 'maria.fernandes@email.com',
            position: 'gestor-operacoes',
            coverLetter: 'Tenho vasta experiência em gestão de operações logísticas e otimização de processos. Acredito que posso contribuir significativamente para melhorar a eficiência da cadeia de delivery.'
        }
    };
