// ==================================================
// SISTEMA COMPLETO DE PROMOÇÕES CraveNow
// ==================================================
...
class PromocoesSystem {
    ...
    this.allPromotions = [
      {
        ...
        description:
          "25% de desconto em todas as pizzas aos sábados e domingos",
        category: "desconto",
        discount: 25,
        validity: "2024-12-30",
        popularity: "high",
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1572802419224-296b0aeee0d9?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
        savings: 3500,
        badge: "Novo",
      },
      {
      ...
      },
      {
        ...
        description:
          "15% de desconto em comida chinesa e japonesa às quartas-feiras",
        category: "desconto",
        discount: 15,
        validity: "2025-02-28",
        popularity: "low",
      ...
      },
      {
        ...
        description:
          "Pequeno-almoço completo por apenas 2.500 Kz (válido até 10h)",
        category: "combo",
        discount: 0,
        validity: "2025-03-31",
        popularity: "medium",
        ...
        image:
          "https://images.unsplash.com/photo-1551782450-17144efb9c50?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
        savings: 1200,
        badge: "Limitado",
      },
      {
        ...
        description:
          "20% de desconto + sobremesa grátis em pedidos acima de 12.000 Kz",
  ...
  setActiveCategory(category) {
    ...
    const activeCard = document.querySelector(
      `.promo-category-card[data-category="${category}"]`
    );
  ...
  applyAdvancedFilters() {
    ...
    const discountRange = document.querySelector(
      'input[name="discountRange"]:checked'
    )?.id;
  ...
  createPromoCard(promo) {
    ...
    col.className =
      this.currentView === "list" ? "col-12 mb-4" : "col-md-6 col-xl-4";
    ...
    col.innerHTML = `
            <div class="card promo-card border-0 shadow-sm h-100" 
                ...
                <div class="position-relative">
                    ...
                    ${
                      promo.badge
                        ? `<span class="promo-badge badge bg-${this.getBadgeColor(
                            promo.badge
                          )}">${promo.badge}</span>`
                        : ""
                    }
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <span class="badge bg-light text-black">
                            <i class="bi ${this.getPopularityIcon(
                              promo.popularity
                            )} text-danger"></i> 
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <small class="text-muted">${this.getValidityText(
                          promo.validity
                        )}</small>
                    </div>
                    ...
                    <div class="mt-3">
                        <span class="text-success fw-bold">
                            <i class="bi bi-coin"></i> Economize ${this.formatCurrency(
                              promo.savings
                            )}
                        </span>
                    </div>
...
function sharePromotion(promoId) {
  if (navigator.share) {
    navigator.share({
      title: "Promoção CraveNow",
      text: "Confira esta promoção incrível no CraveNow!",
