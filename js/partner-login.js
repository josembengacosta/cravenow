...
class PartnerLoginSystem {
  ...
  initializeEventListeners() {
    ...
    document
      .querySelectorAll(".btn-outline-primary, .btn-outline-dark")
      .forEach((btn) => {
  ...
  handleLogin(event) {
    ...
    submitButton.innerHTML =
      '<i class="bi bi-arrow-repeat spinner-border spinner-border-sm"></i> A entrar...';
  ...
  handleSocialLogin(button) {
    ...
    // Show loading state
    button.innerHTML =
      '<i class="bi bi-arrow-repeat spinner-border spinner-border-sm"></i> A conectar...';
...
function demoLogin(role = "admin") {
  ...
  if (demo) {
    ...
    window.partnerLoginSystem.showToast(
      `Credenciais de ${role} preenchidas`,
      "info"
    );
  }
}
