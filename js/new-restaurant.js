// new-restaurants-system.js - Sistema de Novos Restaurantes DeliveryHJ
...
class NewRestaurantsSystem {
    ...
    loadRestaurantsData() {
        ...
        this.restaurants = [
            {
                ...
                description: "Autêntica culinária brasileira com feijoada, picanha e moqueca.",
            ...
            },
            {
                id: 2,
                name: "Tokyo Sushi",
                description: "Sushi fresco e autêntico com ingredientes importados do Japão.",
            ...
            },
            {
                ...
                description: "Pizzas com massa fermentada naturalmente e ingredientes premium.",
            ...
            },
            {
                id: 4,
                name: "Green Life",
                description: "Comida saudável e nutritiva com opções veganas e vegetarianas.",
            ...
            },
            {
                id: 5,
                name: "Burger Master",
                description: "Hambúrgueres artesanais com carne angolana e pão caseiro.",
            ...
            },
            {
                ...
                description: "Culinária tradicional angolana com muamba, funge e calulu.",
        ...
        this.restaurants.sort((a, b) => new Date(b.arrivalDate) - new Date(a.arrivalDate));
    ...
    generateRestaurantHTML(restaurant, index) {
        ...
        return `
            <div class="slide-in-up" style="animation-delay: ${animationDelay}ms">
                <div class="card restaurant-card ${restaurant.isFeatured ? 'featured-restaurant' : ''}" 
                     data-id="${restaurant.id}">
                    <div class="position-relative">
                        <img src="${restaurant.image}" class="restaurant-image w-100" alt="${restaurant.name}">
                        <div class="new-badge">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="category-badge">${this.getCategoryName(restaurant.category)}</span>
                            <span class="arrival-date">Há ${daysAgo} dias</span>
                        </div>
                        
                        <div class="delivery-info mb-3">
                            <i class="bi bi-clock"></i> ${restaurant.deliveryTime} • 
                            <i class="bi bi-truck"></i> ${restaurant.deliveryFee} Kz
                        </div>
                        
                        <div class="d-flex justify-content-between align-items-center">
                            <small class="text-muted">
                                <i class="bi bi-chat"></i> ${restaurant.reviewCount} avaliações
                            </small>
                    ...
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <button class="btn btn-danger w-100" onclick="newRestaurantsSystem.viewRestaurant(${restaurant.id})">
    ...
    updateStats() {
        // Update statistics
        const newThisWeek = this.restaurants.filter(r => this.getDaysAgo(r.arrivalDate) <= 7).length;
        const totalNew = this.restaurants.length;
        const avgRating = (this.restaurants.reduce((sum, r) => sum + r.rating, 0) / totalNew).toFixed(1);
    ...
    subscribeNewsletter() {
        ...
        subscribeBtn.innerHTML = '<i class="bi bi-arrow-repeat spinner-border spinner-border-sm"></i>';
        
        setTimeout(() => {
            this.showToast('🎉 Inscrito com sucesso! Você receberá alertas de novos restaurantes.', 'success');
            emailInput.value = '';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('🚀 Sistema de Novos Restaurantes DeliveryHJ carregado com sucesso!');
});