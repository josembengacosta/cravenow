...
class ContactSystem {
  ...
  initializeEventListeners() {
    ...
    document
      .querySelectorAll(".btn-success, .btn-primary, .btn-warning")
      .forEach((btn) => {
        if (
  ...
  handleContactForm(event) {
    ...
    submitButton.innerHTML =
      '<i class="bi bi-arrow-repeat spinner-border spinner-border-sm"></i> A enviar...';
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center py-4">
                            ...
                            <p class="text-muted">
                                ...
                                Entraremos em contacto através do email <strong>${
                                  formData.email
                                }</strong> 
                                em até 4 horas.
                            </p>
                            <div class="alert alert-info mt-3">
                                ...
                                <strong>Número do protocolo:</strong> DHJ-${Date.now()
                                  .toString()
                                  .slice(-6)}
                            </div>
                        </div>
  ...
  showErrorMessage() {
    this.showToast(
      "Erro ao enviar mensagem. Tente novamente ou use outro método de contacto.",
      "error"
    );
  ...
  fillDemoForm() {
    ...
    document.getElementById("contactMessage").value =
      "Gostaria de sugerir a adição de mais restaurantes de comida tradicional na minha área. Obrigado!";
...
function testContactForm(type = "suporte") {
  const testData = {
    suporte: {
      ...
      subject: "suporte",
      message:
        "Preciso de ajuda com um pedido que não chegou. Número do pedido: #DHJ12345",
    },
    reclamacao: {
      name: "Carlos Mendes",
      ...
      subject: "reclamacao",
      message:
        "O entregador chegou atrasado e a comida estava fria. Espero uma solução para esta situação.",
    },
    sugestao: {
      name: "Ana Pereira",
      ...
      subject: "sugestao",
      message:
        "Sugiro a implementação de opções de pagamento com MB Net para maior segurança nas transações.",
    },
  };
  ...
  if (data && window.contactSystem) {
    ...
    window.contactSystem.showToast(
      `Formulário preenchido para: ${type}`,
      "info"
    );
  }
}
